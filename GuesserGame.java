...
{	
	if(numFromGuesser==numFromPlayer1)
	{
		...
		{
		System.out.println("Game tied with all the players kindly guess correctly");
		}
	...
	else if(numFromGuesser==numFromPlayer2)
	{
		...
		{
			System.out.println("Player 2,player3,player4 won the game");
		}
		else if(numFromGuesser == numFromPlayer3)
		{
		...
		{
			System.out.println("player2 and 4 won the game");
		}
		else {
